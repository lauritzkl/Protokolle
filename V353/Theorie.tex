...
Ein RC-Kreis besteht aus einem Widerstand und einem Kondensator, die in Reihe
...
Wenn die Spannungsquelle nach der Aufladung entfernt wird, entlädt sich der Kondensator.
Es ergibt sich für die Differentialgleichung die selbe wie beim Aufladevorgang,
...
der sich das System seinen Endzustand annähert. Dabei ist R der Widerstand
...
Um eine Gleichung für die Phasenverschiebung herzuleiten, wird zunächst die in Abbildung (\ref{fig:1})
